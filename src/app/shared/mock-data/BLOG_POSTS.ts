...
export const BLOG_POSTS: BlogPost[] = [
	new BlogPost(
		...
		[
			...
			new BlogPostComment(
				...
				new Date("2024-07-27").getTime()
			),
			new BlogPostComment(
				"William",
				"Shit vad bra du är på att koda!",
				new Date("2025-01-22").getTime()
			),
		],
		4,
		false
	...
	new BlogPost(
		...
		[
			new BlogPostComment(
				"Frenka",
				"Det var verkligen blåsigt!",
				new Date("2024-11-10").getTime()
			),

			new BlogPostComment("", "Snygg bild!", new Date("2024-11-10").getTime()),
			new BlogPostComment(
				"TEST",
				"Testar spam: ",
